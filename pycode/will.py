...
# Tuples are used to store multiple elements 
# A tuple is a collection which is unordered and unchangeable.
# Tuples are being identified by ().

# names = ("Will","Harry","Jennifer","James","Henry")

# print(names)

# indexing : It is used to access elements in a tuples
