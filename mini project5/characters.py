...
class Hero(Character):
    def __init__(self, name, health=100, description='Fast and Furious Fur Ball',basicAttackDamage=7,specialAttackDamage=10, defenseDamage=1,basicAttackName='scratch',specialAttackName='special scratch', basicdefenseName='duck'):
        self.__name = name
